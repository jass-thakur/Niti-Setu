...
const mockResponses: Record<string, string> = {
  ...
  "pm-kisan":
    "**PM-Kisan** provides ₹6,000/year to small and marginal farmers. You usually need Aadhaar and land records to apply.",
  "pm-kusum":
    "**PM-KUSUM** helps you install solar pumps with massive subsidies. It's great for reducing electricity bills!",
  "soil":
